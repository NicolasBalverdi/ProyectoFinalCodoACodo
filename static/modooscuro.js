...
function aplicarModoClaro() {
    document.getElementById('modo-estilo').setAttribute('href', '/static/styles-claro.css');
    localStorage.setItem('modo', 'claro');
}

// Función para cambiar a modo oscuro
function aplicarModoOscuro() {
    document.getElementById('modo-estilo').setAttribute('href', '/static/styles-oscuro.css');
